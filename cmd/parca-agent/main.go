...
type flags struct {
	...
	// These flags are considered beta quality. Use them at your own peril.
	DwarfUnwindingPids []int `kong:"help='Unwind stack using .eh_frame information for these processes.'"`
}
